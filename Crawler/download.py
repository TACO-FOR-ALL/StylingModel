...
def download_image(url, product_number, output_directory, verbose):
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"Downloaded: {save_path}") if verbose else None
        else:
...
def download_images_from_csv(csv_file, output_directory, verbose):
    ...
    with open(csv_file, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            product_number = row['id']
            download_image(image_url, product_number, output_directory,verbose)



def download_images_musinsa(verbose):
    directory = DATABASE
    ...
    for file in files:
        if file.endswith(".csv"):
            ...
            download_images_from_csv(csv_file_path, output_directory,verbose)
